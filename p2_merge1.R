...
list1<- list(p2_adnh_updated_20180910.csv, p2_bake_updated_20180910.csv,        
...
p2_feen.csv,         p2_fscd.csv,         p2_ftcb_updated_20180910.csv,        
p2_gali.csv,         p2_grac.csv,         p2_gsdc.csv,        
p2_gtpc_updated_20180914.csv,         p2_guts.csv,         p2_kmct.csv ,       
p2_ksud.csv,         p2_mrsc.csv,         p2_ncmh.csv ,       
p2_nhrv_updated_20180910.csv,         p2_nhs2.csv,         p2_nhsy.csv ,       
p2_niut.csv,         p2_onga.csv ,       
p2_port_updated_20180910.csv,         p2_pris.csv ,       
p2_prom.csv,         p2_ring.csv,         p2_safr.csv ,       
p2_satu.csv,         p2_seep.csv ,        p2_shrs.csv ,       
p2_stro.csv,         p2_teic.csv ,        p2_vets.csv ,       
p2_vris_update_20180914.csv,         p2_wach.csv,         p2_wang_updated_20180910.csv ,       
p2_yehu.csv)
...
#the following should be dichotomous
table(p2list$Sex) #STRONGSTAR has some missing SEX info
table(p2list$Case) 
table(p2list$Current_PTSD_Dx)
table(p2list$Lifetime_PTSD_Dx)

#UNUSED OTHER OPTION -- read in and binds together all files but only works with equal number of columns
