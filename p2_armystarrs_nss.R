...
datchild <- read.csv('C:/Users/Nievergelt Lab/Documents/GWAS_Freeze2_CURRENT/14_15_16_ArmySTARRS/pheno_2/pgcid_nss_data_wpsw.csv',header=T,  na.strings=c(NA,999))

#########################################################
# SUBSET 
#########################################################
datchild1 <- subset(datchild, select= c(PGCid,	
                                    CA_TouchSex,
                                    CA_SexAbuse,
                                    CA_PhysicalAbuse,
                                    CA_HitBruise,
...
#Export data
#----------------------------------------------------------------------------------------
write.csv(lt_scores, "C:/Users/Nievergelt Lab/Documents/GWAS_Freeze2_CURRENT/14_15_16_ArmySTARRS/pheno_2/p2_nss20190107.csv",quote=T,row.names=F,na="NA")
